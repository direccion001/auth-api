...
router.patch("/:id_appsheet", async (req, res, next) => {
  ...
  try {
    ...
    if (solicitaStatus) {
      ...
      // Company Viewer solo muestra la transición normal hacia No aplica.
      // Esta excepción permite que el stack de Undo restaure el status académico
      // exacto que existía antes (1, 3 o 4), únicamente desde No aplica.
